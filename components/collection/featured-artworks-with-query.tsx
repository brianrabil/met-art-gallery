...
export default function FeaturedArtworksWithQuery() {
...
function FeaturedItemCard({ item }: { item: any }) {
  ...
  return (
    <Card key={item.id} className="overflow-hidden" onMouseEnter={handleMouseEnter}>
