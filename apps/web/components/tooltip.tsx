...
export function TooltipExample() {
	return (
		<Tooltip text="Add to library">
			<button
				type="button"
				className="rounded-xl border border-neutral-300 bg-neutral-100 px-4 py-2 text-sm font-medium text-neutral-500 dark:border-neutral-900 dark:bg-neutral-950 dark:text-neutral-400"
			>
				Hover Me
			</button>
		</Tooltip>
